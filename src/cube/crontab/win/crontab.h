#ifndef _WIN_TIMER_CRONTAB_H
#define _WIN_KCRONTAB_H
#include <list>
#include <windows.h>
#include "cube/timer/kcronitem.h"
...
namespace fsk{
	...
	private:
		...
		static unsigned __stdcall thread_check_func(void *arg);

		/*thread function to run the time up task jobs*/
		static unsigned __stdcall thread_job_func(void *arg);
